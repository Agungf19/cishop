				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text color_header"><i class="fas fa-phone"></i></span>
								</div>
								<?= form_input(['type' => 'number', 'name' => 'no_tlp', 'value' => $input->no_tlp, 'class' => 'form-control', 'required' => true]) ?>
							</div>
							<?= form_error('name') ?>
						</div>
					</div>
