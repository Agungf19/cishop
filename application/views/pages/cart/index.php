					...
					<div class="table-responsive">
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr class="text-white">
									<td colspan="2"></td>
									<td class="text-center bg-info"><strong>Total:</strong></td>
									<td class="text-center bg-info"><strong>Rp<?= number_format(array_sum(array_column($content, 'subtotal')), 0, ',', '.') ?>,-</strong></td>
									<td class=" bg-info"></td>
								</tr>
							</tbody>
						</table>
